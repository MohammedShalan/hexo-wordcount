...
var counter = function (content) {
  ...
  const ar = (content.match(/[\u0600-\u06FF]/g) || []).length;
  const en = (content.replace(/[\u4E00-\u9FA5]/g, '').match(/[a-zA-Z0-9_\u0392-\u03c9\u0400-\u04FF]+|[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|[\u00E4\u00C4\u00E5\u00C5\u00F6\u00D6]+|\w+/g) || []).length;
  return [cn, en,ar];
};

hexo.extend.helper.register('min2read', function (content, { cn = 300,ar=200, en = 160 } = {}) {
  var len = counter(content);
  var readingTime = len[0] / cn + len[1] / ar + len[2] / en;
  return readingTime < 1 ? '1' : parseInt(readingTime, 10);
});

hexo.extend.helper.register('wordcount', function (content) {
  var len = counter(content);
  var count = len[0] + len[1] + len[2];
  if (count < 1000) {
    return count;
  }
